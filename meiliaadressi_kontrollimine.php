<input type="text" id="meil" placeholder="sinumeil@veebiaadress.lühend" size="25"
       onkeypress="Javascript: if (event.keyCode==13) kontrolliEmaili();"/>
